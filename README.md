...
Quando um recurso nao e encontrado, o Spring retorna um erro generico por padrao. Para retornar uma mensagem estruturada e com o status correto, crie um handler global:
...
Suba a aplicacao e tente buscar um cliente que nao existe:
...
## 11. Proximos passos: autenticacao
...
1. Adicionar a dependencia **Spring Security** no `pom.xml`
2. Configurar autenticacao com **JWT** (JSON Web Token)
...
Isso sera abordado em um proximo guia.
