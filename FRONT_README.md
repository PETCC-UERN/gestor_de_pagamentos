...
Este guia acompanha a construcao do frontend do gestor de pagamentos, consumindo a API REST construida no guia de backend. Ele foi escrito pensando em quem esta tendo o primeiro contato com desenvolvimento web frontend.
